...
export default function EmployeeProfilePage({ params }: { params: { id: string } }) {
  ...
  const statusColors = {
    ...
    expiring_soon: 'text-yellow-600 bg-yellow-50',
          ...
          <div className="space-y-3">
            {employee.documents && employee.documents.length > 0 ? (
              employee.documents.map((doc) => {
                const StatusIcon = statusIcons[doc.status] || statusIcons.missing
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900">{doc.name || doc.type}</p>
                        {doc.expiryDate && (
              ...
              <p className="text-center text-gray-500 py-4">لا توجد مستندات</p>
            )}
          </div>
        </DataCard>
        ...
        <DataCard>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className={`p-4 rounded-xl bg-red-50 ${employee.advances === undefined ? 'col-span-2' : ''}`}>
